...
ASPIRATION_WINDOW_SIZE = 32 # centipawns (H8: tightened from 100 to detect score instability)
...
SINGULAR_EXTENSION_MARGIN = 190 # centipawns
...
# Razoring
RAZORING_MARGIN = 760 # Tightened from 700

# Futility Pruning
FP_BASE = 254      # 增加邊際
FP_MULTIPLIER = 254 # 增加邊際

# Reverse Futility Pruning
RFP_MAX_DEPTH = 6            # 降低深度限制增加安全性
RFP_BASE_MULT = 254           # 增加邊際
...
LMR_MIN_QUIET_MOVE_INDEX = 4 # 延後 LMR
...
# ProbCut
PROBCUT_R = 4
PROBCUT_MARGIN = 190 # centipawns

# Delta Pruning
DELTA_PRUNING_MARGIN = 508
