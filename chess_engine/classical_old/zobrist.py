...
from chess_engine.classical_old.engine_types import piece_bbs_signature, game_state_signature
...
SIDE_TO_MOVE_KEY = np.uint64(0xf8d626aaaf278509)
"""
...
def compute_initial_hash(piece_bbs: np.ndarray, game_state: np.ndarray) -> np.uint64:
    ...
    # 如果是白方走棋，XOR 行棋方鍵值 (依據 Polyglot 標準，白方為特殊方)
