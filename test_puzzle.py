...
def run_puzzle_test():
    ...
    for i, puzzle in enumerate(puzzles):
        ...
        (best_move, best_eval, nodes_searched, quiescence_nodes, cutoffs, tt_hits,
         last_depth, nmc, fp, ru, qdp, qsp) = iterative_deepening_search(
        ...
        print(f"Null Move Cutoffs: {nmc}")
        print(f"Futility Pruned: {fp}")
        print(f"Razoring Used: {ru}")
        print(f"QS Delta Pruned: {qdp}")
        print(f"QS SEE Pruned: {qsp}")
        print("-------------------------")
        print("")
