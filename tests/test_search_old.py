...
from chess_engine.classical_old.transposition_table import TT_SIZE_MB, create_transposition_table, clear_transposition_table, estimate_tt_occupancy_percentage
...
def clear_numba_cache():
    ...
    """
    log_info("--- Clearing Numba Cache (Old) ---")
...
def run_search_test():
    ...
    print("--- WARMING UP (Compiling JIT functions - Old) ---")
    ...
    log_info("--- Starting Iterative Deepening Search Test (Old) ---")
    log_info(f"FEN: {fen}")
