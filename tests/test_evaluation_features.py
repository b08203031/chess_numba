...
from chess_engine.classical.evaluation import _evaluate_pawn_shield_for_color, _evaluate_king_attackers, evaluate_king_safety
from chess_engine.classical.zobrist import get_lsb_index
from chess_engine.classical.constants import KING_SAFETY_TABLE, KING_TROPISM_MAX_DISTANCE, KING_TROPISM_WEIGHTS, PAWN_STORM_PENALTY_BY_RANK
from chess_engine.classical.evaluation import MANHATTAN_DISTANCE
...
class TestKingAttackerEvaluation(unittest.TestCase):
    ...
    def test_two_knights_attacking(self):
        ...
        from chess_engine.classical.evaluation import _compute_all_attacks
